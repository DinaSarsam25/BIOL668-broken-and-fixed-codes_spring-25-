...
#for fn in "$BACKUP_FILES"/*; do # I tried this method, but it did not work when I run the script!.
#	if [ -f "$fn: ]; 
#		cp "$fn" "$HOME/BACKUP_FILES/"
#		echo "$fncopied to $HOME/BACKUP_FILES"
#	fi
...
print_info () {
	...
	echo "Total disk usage of files in $HOME/BACKUP_FILES:"
